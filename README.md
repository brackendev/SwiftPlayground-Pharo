Due to the fragility of Xcode's Swift Playgrounds, my Pharo implementation has resulted in more stability with the added benefits of working with Swift output in the powerful Pharo environment and accessing Swift ASTs.
...
Use Swift within Pharo via the integrated Swift Playground or within Pharo Smalltalk code. Inspect output, inspect Swift ASTs, and more.
